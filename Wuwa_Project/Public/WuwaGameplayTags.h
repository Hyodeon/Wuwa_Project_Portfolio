...
namespace WuwaGameplayTags
{
	...
	WUWA_PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Resource_Valor);
	WUWA_PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Resource_BladeDance);
	WUWA_PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Resource_Concerto);
	WUWA_PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Resource_Ultimate);

	// ================= [상태 (State) 태그] =================
	WUWA_PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Groggy);
	WUWA_PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_SuperArmor);
	WUWA_PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_HyperArmor);
